...
class _InputFormalPhoto2State extends State<InputFormalPhoto2> {
  String imageFileName = "Photo 1 (required)";
  String? _selectedFormalImage1;
...
class InputFormalPhoto3 extends StatefulWidget {
  final Function(XFile) onImageFormalSelected;
  final StoreJobFormBloc formBloc;
  const InputFormalPhoto3(
      {super.key, required this.onImageFormalSelected, required this.formBloc});

  @override
  State<InputFormalPhoto3> createState() => _InputFormalPhoto3State();
}

class _InputFormalPhoto3State extends State<InputFormalPhoto3> {
  String imageFileName = "Photo 2 (required)";
  String? _selectedFormalImage1;
