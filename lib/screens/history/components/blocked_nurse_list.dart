...
class BlockedNurseList extends StatefulWidget {
  const BlockedNurseList({
    super.key,
    required this.src,
  });
  ...
  @override
  State<BlockedNurseList> createState() => _BlockedNurseListState();
}

class _BlockedNurseListState extends State<BlockedNurseList> {
  @override
