...
import 'package:private_nurse_for_client/models/registration/register_payment_request_model.dart';
...
class UserResource {
  ...
  // Call Register API
  static Resource register(RegisterClientRequestModel requestModel) {
    return Resource(
        url: 'client/register',
  ...
  static Resource deleteProfile() {
    return Resource(
        url: 'client/delete-profile',
        parse: (response) {
          return DefaultResponseModel(json.decode(response.body));
        });
  }
