...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color: white; box-shadow: 3px 9px rgba(0, 0, 0, 0.02);">
        <div class="collapse navbar-collapse" id="navbarText">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="flex-sm-fill text-sm-center nav-link active" style="color: #00A3D8" href="/show">Sales Report</a>
            </li>
            <li class="nav-item">
    ...
    {{-- <nav class="navbar navbar-light flex-column flex-sm-row" style="background-color: #e3f2fd;">
        ...
        <a class="flex-sm-fill text-sm-center nav-link" href="/schedule"><span><x-polaris-major-inventory class="h-1 w-1" style="color: green"/></span><span class="d-none d-md-inline">Schedule</a>
        <a class="nav-link active" href="/show" >Sales Report</a>
        <a class="flex-sm-fill text-sm-center nav-link" href="/cart">Payment</a>
